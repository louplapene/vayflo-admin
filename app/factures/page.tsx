    ...
    <AppShell>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          {[
            { label: "Encaissé", value: totalPaye, color: "text-green-600", bg: "bg-green-50 border-green-100" },
                    ...
                    <tr key={f.id} className="hover:bg-gray-50">
                      ...
                      <td className="table-td">
                        <a href={`/clients/${f.tenant_id}`} className="font-medium text-gray-900 hover:text-vayflo-600">
                          {(f.tenants as { nom: string } | null)?.nom || "—"}
                        </a>
                      </td>
                      <td className="table-td text-gray-500 max-w-xs truncate">{f.objet || "—"}</td>
